...
def main(dataset):
    experiment_name = "01 - Naive Bayes"
    target = "label"
    ...
    plot_name = "results/"+dataset+"_01_NBayes_SHAP.png"
    plt.savefig(plot_name)

    project.end_experiment(experiment_name, exec_id, hyperparams={})

    write_shap_values(shap_values,feature_names, "results/"+dataset+"_01_NBayes_SHAP.csv")
